/**==== Hashing Implementation: Collision Reducing technique - Double Hashing ====**/


/*
 * This program shows the implementation of the hashing by reducing collision using Double Hashing.
