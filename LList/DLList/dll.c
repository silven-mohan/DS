/** ===== Double Linked List: Operations Implementation ===== **/


/** ===== Documentation ===== **/
/*
 * This program shows the implementation of the operations on a Double Linked List.
 * In this we do the following processes:
	...
	* Merge two lists into a double list and print the merged list.
...
int main()
{
	...
	do
	{
		...
		printf("\n1. Traversal\n2. Backward Traversal\n3. Insertion of Nodes\n4. Deletion of Nodes\n5. Searching of a node\n6. Merging of two lists\n7. Reversing of a list\n8. Modify a node's value\n9. Exit\n");
		scanf("%d", &choice);
		printf("\n===============================\n\n");
			...
			case 2:
				{
					...
					if(reverseTraverse(header))  return 1;
					break;
				}
			case 3:
				{
...
//createList():
//This function creates and initializes all nodes in the list.
